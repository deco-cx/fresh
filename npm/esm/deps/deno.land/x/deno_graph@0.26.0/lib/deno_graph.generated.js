...
function __wbg_adapter_20(arg0, arg1, arg2) {
    wasm
        ._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__haaf10ac45db29e97(arg0, arg1, addHeapObject(arg2));
}
 ...
 * @returns {Module}
 */
export function parseModule(specifier, maybe_headers, maybe_jsx_import_source_module, content, maybe_kind, maybe_resolve, maybe_resolve_types) {
    try {
        ...
        var ptr2 = passStringToWasm0(content, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len2 = WASM_VECTOR_LEN;
        wasm.parseModule(retptr, ptr0, len0, addHeapObject(maybe_headers), ptr1, len1, ptr2, len2, addHeapObject(maybe_kind), isLikeNone(maybe_resolve) ? 0 : addHeapObject(maybe_resolve), isLikeNone(maybe_resolve_types) ? 0 : addHeapObject(maybe_resolve_types));
 ...
 */
export function createGraph(roots, load, maybe_jsx_import_source_module, maybe_cache_info, maybe_resolve, maybe_resolve_types, maybe_check, maybe_get_checksum, maybe_lockfile_name, maybe_build_kind, maybe_imports) {
    ...
    var ptr1 = isLikeNone(maybe_lockfile_name)
        ? 0
        : passStringToWasm0(maybe_lockfile_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len1 = WASM_VECTOR_LEN;
    var ptr2 = isLikeNone(maybe_build_kind)
        ? 0
        : passStringToWasm0(maybe_build_kind, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    var len2 = WASM_VECTOR_LEN;
    var ret = wasm.createGraph(addHeapObject(roots), addHeapObject(load), ptr0, len0, isLikeNone(maybe_cache_info) ? 0 : addHeapObject(maybe_cache_info), isLikeNone(maybe_resolve) ? 0 : addHeapObject(maybe_resolve), isLikeNone(maybe_resolve_types) ? 0 : addHeapObject(maybe_resolve_types), isLikeNone(maybe_check) ? 0 : addHeapObject(maybe_check), isLikeNone(maybe_get_checksum) ? 0 : addHeapObject(maybe_get_checksum), ptr1, len1, ptr2, len2, addHeapObject(maybe_imports));
...
function __wbg_adapter_69(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__had5d8f15ca1c7c5b(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
const ModuleFinalization = new FinalizationRegistry((ptr) => wasm.__wbg_module_free(ptr));
/** */
export class Module {
    static __wrap(ptr) {
...
const ModuleGraphFinalization = new FinalizationRegistry((ptr) => wasm.__wbg_modulegraph_free(ptr));
/** */
export class ModuleGraph {
    ...
    resolveDependency(specifier, referrer, prefer_types) {
        try {
            ...
            var ptr0 = passStringToWasm0(specifier, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len0 = WASM_VECTOR_LEN;
            var ptr1 = passStringToWasm0(referrer, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            var len1 = WASM_VECTOR_LEN;
            wasm.modulegraph_resolveDependency(retptr, this.ptr, ptr0, len0, ptr1, len1, prefer_types);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            let v2;
            if (r0 !== 0) {
    ...
    toString(maybe_no_color) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.modulegraph_toString(retptr, this.ptr, isLikeNone(maybe_no_color) ? 0xFFFFFF : maybe_no_color ? 1 : 0);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            return getStringFromWasm0(r0, r1);
        }
...
switch (wasm_url.protocol) {
    case "file:": {
        if ("permissions" in dntShim.Deno) {
            dntShim.Deno.permissions.request({ name: "read", path: wasm_url });
        }
    ...
    case "http:": {
        if ("permissions" in dntShim.Deno) {
            dntShim.Deno.permissions.request({ name: "net", host: wasm_url.host });
        }
