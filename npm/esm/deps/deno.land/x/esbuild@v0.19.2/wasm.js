        ...
        let onmessage = (postMessage => {
            ...
            for (let r = self; r; r = Object.getPrototypeOf(r))
                for (let f of Object.getOwnPropertyNames(r))
                    f in globalThis || Object.defineProperty(globalThis, f, { get: () => self[f] });
            (() => {
                const r = () => { const c = new Error("not implemented"); return c.code = "ENOSYS", c; };
                if (!globalThis.fs) {
                    let c = "";
                    globalThis.fs = { constants: { O_WRONLY: -1, O_RDWR: -1, O_CREAT: -1, O_TRUNC: -1, O_APPEND: -1, O_EXCL: -1 }, writeSync(n, s) {
                            c += g.decode(s);
                            const i = c.lastIndexOf(`
`);
                            return i != -1 && (console.log(c.substring(0, i)), c = c.substring(i + 1)), s.length;
                        }, write(n, s, i, a, h, u) { if (i !== 0 || a !== s.length || h !== null) {
                            u(r());
                            return;
                        } const d = this.writeSync(n, s); u(null, d); }, chmod(n, s, i) { i(r()); }, chown(n, s, i, a) { a(r()); }, close(n, s) { s(r()); }, fchmod(n, s, i) { i(r()); }, fchown(n, s, i, a) { a(r()); }, fstat(n, s) { s(r()); }, fsync(n, s) { s(null); }, ftruncate(n, s, i) { i(r()); }, lchown(n, s, i, a) { a(r()); }, link(n, s, i) { i(r()); }, lstat(n, s) { s(r()); }, mkdir(n, s, i) { i(r()); }, open(n, s, i, a) { a(r()); }, read(n, s, i, a, h, u) { u(r()); }, readdir(n, s) { s(r()); }, readlink(n, s) { s(r()); }, rename(n, s, i) { i(r()); }, rmdir(n, s) { s(r()); }, stat(n, s) { s(r()); }, symlink(n, s, i) { i(r()); }, truncate(n, s, i) { i(r()); }, unlink(n, s) { s(r()); }, utimes(n, s, i, a) { a(r()); } };
                }
                if (globalThis.process || (globalThis.process = { getuid() { return -1; }, getgid() { return -1; }, geteuid() { return -1; }, getegid() { return -1; }, getgroups() { throw r(); }, pid: -1, ppid: -1, umask() { throw r(); }, cwd() { throw r(); }, chdir() { throw r(); } }), !globalThis.crypto)
                ...
                globalThis.Go = class {
                    constructor() { this.argv = ["js"], this.env = {}, this.exit = e => { e !== 0 && console.warn("exit code:", e); }, this._exitPromise = new Promise(e => { this._resolveExitPromise = e; }), this._pendingEvent = null, this._scheduledTimeouts = new Map, this._nextCallbackTimeoutID = 1; const c = (e, t) => { this.mem.setUint32(e + 0, t, !0), this.mem.setUint32(e + 4, Math.floor(t / 4294967296), !0); }, n = e => { const t = this.mem.getUint32(e + 0, !0), o = this.mem.getInt32(e + 4, !0); return t + o * 4294967296; }, s = e => { const t = this.mem.getFloat64(e, !0); if (t === 0)
                        return; if (!isNaN(t))
                        return t; const o = this.mem.getUint32(e, !0); return this._values[o]; }, i = (e, t) => { if (typeof t == "number" && t !== 0) {
                        if (isNaN(t)) {
                        ...
                        return;
                    } let l = this._ids.get(t); l === void 0 && (l = this._idPool.pop(), l === void 0 && (l = this._values.length), this._values[l] = t, this._goRefCounts[l] = 0, this._ids.set(t, l)), this._goRefCounts[l]++; let m = 0; switch (typeof t) {
                        case "object":
                            t !== null && (m = 1);
                            break;
                        case "string":
                        ...
                        case "function":
                            m = 4;
                            break;
                    } this.mem.setUint32(e + 4, 2146959360 | m, !0), this.mem.setUint32(e, l, !0); }, a = e => { const t = n(e + 0), o = n(e + 8); return new Uint8Array(this._inst.exports.mem.buffer, t, o); }, h = e => { const t = n(e + 0), o = n(e + 8), l = new Array(o); for (let m = 0; m < o; m++)
                        l[m] = s(t + m * 8); return l; }, u = e => { const t = n(e + 0), o = n(e + 8); return g.decode(new DataView(this._inst.exports.mem.buffer, t, o)); }, d = Date.now() - performance.now(); this.importObject = { go: { "runtime.wasmExit": e => { e >>>= 0; const t = this.mem.getInt32(e + 8, !0); this.exited = !0, delete this._inst, delete this._values, delete this._goRefCounts, delete this._ids, delete this._idPool, this.exit(t); }, "runtime.wasmWrite": e => { e >>>= 0; const t = n(e + 8), o = n(e + 16), l = this.mem.getInt32(e + 24, !0); globalThis.fs.writeSync(t, new Uint8Array(this._inst.exports.mem.buffer, o, l)); }, "runtime.resetMemoryDataView": e => { e >>>= 0, this.mem = new DataView(this._inst.exports.mem.buffer); }, "runtime.nanotime1": e => { e >>>= 0, c(e + 8, (d + performance.now()) * 1e6); }, "runtime.walltime": e => { e >>>= 0; const t = new Date().getTime(); c(e + 8, t / 1e3), this.mem.setInt32(e + 16, t % 1e3 * 1e6, !0); }, "runtime.scheduleTimeoutEvent": e => { e >>>= 0; const t = this._nextCallbackTimeoutID; this._nextCallbackTimeoutID++, this._scheduledTimeouts.set(t, setTimeout(() => { for (this._resume(); this._scheduledTimeouts.has(t);)
                                console.warn("scheduleTimeoutEvent: missed timeout event"), this._resume(); }, n(e + 8) + 1)), this.mem.setInt32(e + 16, t, !0); }, "runtime.clearTimeoutEvent": e => { e >>>= 0; const t = this.mem.getInt32(e + 8, !0); clearTimeout(this._scheduledTimeouts.get(t)), this._scheduledTimeouts.delete(t); }, "runtime.getRandomData": e => { e >>>= 0, crypto.getRandomValues(a(e + 8)); }, "syscall/js.finalizeRef": e => { e >>>= 0; const t = this.mem.getUint32(e + 8, !0); if (this._goRefCounts[t]--, this._goRefCounts[t] === 0) {
                                const o = this._values[t];
                                this._values[t] = null, this._ids.delete(o), this._idPool.push(t);
                            } }, "syscall/js.stringVal": e => { e >>>= 0, i(e + 24, u(e + 8)); }, "syscall/js.valueGet": e => { e >>>= 0; const t = Reflect.get(s(e + 8), u(e + 16)); e = this._inst.exports.getsp() >>> 0, i(e + 32, t); }, "syscall/js.valueSet": e => { e >>>= 0, Reflect.set(s(e + 8), u(e + 16), s(e + 32)); }, "syscall/js.valueDelete": e => { e >>>= 0, Reflect.deleteProperty(s(e + 8), u(e + 16)); }, "syscall/js.valueIndex": e => { e >>>= 0, i(e + 24, Reflect.get(s(e + 8), n(e + 16))); }, "syscall/js.valueSetIndex": e => { e >>>= 0, Reflect.set(s(e + 8), n(e + 16), s(e + 24)); }, "syscall/js.valueCall": e => { e >>>= 0; try {
                            ...
                            } }, "syscall/js.valueInvoke": e => { e >>>= 0; try {
                            ...
                            } }, "syscall/js.valueNew": e => { e >>>= 0; try {
                                const t = s(e + 8), o = h(e + 16), l = Reflect.construct(t, o);
                                e = this._inst.exports.getsp() >>> 0, i(e + 40, l), this.mem.setUint8(e + 48, 1);
                            }
                            catch (t) {
                                e = this._inst.exports.getsp() >>> 0, i(e + 40, t), this.mem.setUint8(e + 48, 0);
                            } }, "syscall/js.valueLength": e => { e >>>= 0, c(e + 16, parseInt(s(e + 8).length)); }, "syscall/js.valuePrepareString": e => { e >>>= 0; const t = f.encode(String(s(e + 8))); i(e + 16, t), c(e + 24, t.length); }, "syscall/js.valueLoadString": e => { e >>>= 0; const t = s(e + 8); a(e + 16).set(t); }, "syscall/js.valueInstanceOf": e => { e >>>= 0, this.mem.setUint8(e + 24, s(e + 8) instanceof s(e + 16) ? 1 : 0); }, "syscall/js.copyBytesToGo": e => { e >>>= 0; const t = a(e + 8), o = s(e + 32); if (!(o instanceof Uint8Array || o instanceof Uint8ClampedArray)) {
                                this.mem.setUint8(e + 48, 0);
                                return;
                            } const l = o.subarray(0, t.length); t.set(l), c(e + 40, l.length), this.mem.setUint8(e + 48, 1); }, "syscall/js.copyBytesToJS": e => { e >>>= 0; const t = s(e + 8), o = a(e + 16); if (!(t instanceof Uint8Array || t instanceof Uint8ClampedArray)) {
                                this.mem.setUint8(e + 48, 0);
                                return;
                            } const l = o.subarray(0, t.length); t.set(l), c(e + 40, l.length), this.mem.setUint8(e + 48, 1); }, debug: e => { console.log(e); } } }; }
                    async run(c) { if (!(c instanceof WebAssembly.Instance))
                        throw new Error("Go.run: WebAssembly.Instance expected"); this._inst = c, this.mem = new DataView(this._inst.exports.mem.buffer), this._values = [NaN, 0, null, !0, !1, globalThis, this], this._goRefCounts = new Array(this._values.length).fill(1 / 0), this._ids = new Map([[0, 1], [null, 2], [!0, 3], [!1, 4], [globalThis, 5], [this, 6]]), this._idPool = [], this.exited = !1; let n = 4096; const s = e => { const t = n, o = f.encode(e + "\0"); return new Uint8Array(this.mem.buffer, n, o.length).set(o), n += o.length, n % 8 !== 0 && (n += 8 - n % 8), t; }, i = this.argv.length, a = []; this.argv.forEach(e => { a.push(s(e)); }), a.push(0), Object.keys(this.env).sort().forEach(e => { a.push(s(`${e}=${this.env[e]}`)); }), a.push(0); const u = n; a.forEach(e => { this.mem.setUint32(n, e, !0), this.mem.setUint32(n + 4, 0, !0), n += 8; }); const d = 4096 + 8192; if (n >= d)
                        throw new Error("total length of command line and environment variables exceeds limit"); this._inst.exports.run(i, u), this.exited && this._resolveExitPromise(), await this._exitPromise; }
                    _resume() { if (this.exited)
                        throw new Error("Go program has already exited"); this._inst.exports.resume(), this.exited && this._resolveExitPromise(); }
                    _makeFuncWrapper(c) { const n = this; return function () { const s = { id: c, this: this, args: arguments }; return n._pendingEvent = s, n._resume(), s.result; }; }
                };
            })(), onmessage = ({ data: r }) => {
...
`)), c = d[d.length - 1];
                ...
                let n = [], s, i = 0;
                onmessage = ({ data: h }) => { h.length > 0 && (n.push(h), s && s()); }, g.read = (h, u, d, e, t, o) => { if (h !== 0 || d !== 0 || e !== u.length || t !== null)
                    throw new Error("Bad read"); if (n.length === 0) {
                    s = () => g.read(h, u, d, e, t, o);
                    return;
                } let l = n[0], m = Math.max(0, Math.min(e, l.length - i)); u.set(l.subarray(i, i + m), d), i += m, i === l.length && (n.shift(), i = 0), o(null, m); };
                let a = new globalThis.Go;
                a.argv = ["", "--service=0.19.2"], tryToInstantiateModule(r, a).then(h => { postMessage(null), a.run(h); }, h => { postMessage(h); });
            };
            async function tryToInstantiateModule(r, f) { if (r instanceof WebAssembly.Module)
                return WebAssembly.instantiate(r, f.importObject); const g = await fetch(r); if (!g.ok)
                throw new Error(`Failed to download ${JSON.stringify(r)}`); if ("instantiateStreaming" in WebAssembly && /^application\/wasm($|;)/i.test(g.headers.get("Content-Type") || ""))
                return (await WebAssembly.instantiateStreaming(g, f.importObject)).instance; const c = await g.arrayBuffer(); return (await WebAssembly.instantiate(c, f.importObject)).instance; }
...
export { analyzeMetafile, analyzeMetafileSync, build, buildSync, context, formatMessages, formatMessagesSync, initialize, stop, transform, transformSync, version };
