...
export const saveDependencies = (deps) => saveFile(DEPENDENCIES_SNAP, new TextEncoder().encode(JSON.stringify([...deps.entries()])));
export const saveSnapshot = async (filesystem, dependencies) => {
    if (!isSupported())
        return;
