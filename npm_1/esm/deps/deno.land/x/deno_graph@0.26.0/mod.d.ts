 ...
 */
export declare function createGraph(rootSpecifier: string, options?: CreateGraphOptions): Promise<ModuleGraph>;
/** Create a module graph using the same algorithms that are used in the Deno
 * CLI, resolving with the module graph for further processing.
 *
 * A default `load()` function is provided which will attempt to load local
 ...
 * @param options A set of options for building the graph
 */
export declare function createGraph(rootSpecifiers: string[] | [string, ModuleKind][], options?: CreateGraphOptions): Promise<ModuleGraph>;
 ...
 */
export declare function parseModule(specifier: string, content: string, options?: ParseModuleOptions): Module;
