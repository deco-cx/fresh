...
export declare function nonce(val: string): string;
...
export declare const CSP_CONTEXT: any;
export declare function useCSP(mutator: (csp: ContentSecurityPolicy) => void): void;
